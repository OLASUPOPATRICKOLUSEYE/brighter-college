...
const menuItems: MenuGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: <MdSettings />, label: "User General Complaint", href: "/list/front-office/user-general-complaint", visible: ["admin", "teacher"] },
    ...
    },
  {
    ...
    items: [
      { icon: <MdPerson />, label: "Student Details", href: "/list/student-information/student-detail", visible: ["admin", "teacher"] },
      { icon: <MdPersonAdd />, label: "Student Admission", href: "/list/student-information/student-admission", visible: ["admin", "teacher"] },
      { icon: <MdOnlinePrediction />, label: "Online Admission", href: "/list/student-information/online-admission", visible: ["admin", "teacher"] },
  ...
  },
  {
    ...
    items: [
      { icon: <MdPayment />, label: "Collect Fees", href: "/list/fees-collection/collect-fees", visible: ["admin", "teacher"] },
      { icon: <MdAccountBalance />, label: "Offline Bank Payment", href: "/list/fees-collection/offline-bank-payment", visible: ["admin", "teacher"] },
      { icon: <MdSearch />, label: "Search Fees Payment", href: "/list/fees-collection/search-fees-payment", visible: ["admin", "teacher"] },
      { icon: <MdSearch />, label: "Search Due Fees", href: "/list/fees-collection/search-fees-due", visible: ["admin", "teacher"] },
      { icon: <MdAttachMoney />, label: "Fees Master", href: "/list/fees-collection/fees-master", visible: ["admin", "teacher"] },
      { icon: <MdAttachMoney />, label: "Quick Fees", href: "/list/fees-collection/quick-fees", visible: ["admin", "teacher"] },
      { icon: <MdGroup />, label: "Fees Group", href: "/list/fees-collection/fees-group", visible: ["admin", "teacher"] },
      { icon: <MdLabel />, label: "Fees Type", href: "/list/fees-collection/fees-type", visible: ["admin", "teacher"] },
      { icon: <MdMoneyOff />, label: "Fees Discount", href: "/list/fees-collection/fees-discount", visible: ["admin", "teacher"] },
      { icon: <MdForward />, label: "Fees Carry Forward", href: "/list/fees-collection/fees-carry-forward", visible: ["admin", "teacher"] },
      { icon: <MdNotifications />, label: "Fees Reminder", href: "/list/fees-collection/fees-reminder", visible: ["admin", "teacher"] },
    ],
  },
  {
    ...
    items: [
      { icon: <MdCastForEducation />, label: "Online Course", href: "/list/online-courses/online-course", visible: ["admin", "teacher"] },
      { icon: <MdAccountBalanceWallet />, label: "Offline Payment", href: "/list/online-courses/offline-payment", visible: ["admin", "teacher"] },
      { icon: <MdCategory />, label: "Course Category", href: "/list/online-courses/category", visible: ["admin", "teacher"] },
      { icon: <MdQuiz />, label: "Question Bank", href: "/list/online-courses/question-bank", visible: ["admin", "teacher"] },
      { icon: <MdAssessment />, label: "Online Course Report", href: "/list/online-courses/report", visible: ["admin", "teacher"] },
      { icon: <MdSettings />, label: "Setting", href: "/list/online-courses/setting", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Multi Branch",
    ...
    items: [
      ...
      { icon: <MdInsertChart />, label: "Report", href: "/list/multi-branch/branch-report", visible: ["admin", "teacher"] },
      { icon: <MdSettings />, label: "Setting", href: "/list/multi-branch/branch-setting", visible: ["admin", "teacher"] },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: <MdVideoCall />, label: "Live Meeting", href: "/list/gmeet/live-meeting", visible: ["admin", "teacher"] },
      { icon: <MdAssessment />, label: "Live Class Report", href: "/list/gmeet/class-report", visible: ["admin", "teacher"] },
      { icon: <MdAssessment />, label: "Live Meeting Report", href: "/list/gmeet/meeting-report", visible: ["admin", "teacher"] },
  ...
  },
  {
    ...
    items: [
      { icon: <MdVideoCall />, label: "Live Meeting", href: "/list/zoom/live-meeting", visible: ["admin", "teacher"] },
      { icon: <MdLiveTv />, label: "Live Classes", href: "/list/zoom/live-classes", visible: ["admin", "teacher"] },
      { icon: <MdAssessment />, label: "Live Class Report", href: "/list/zoom/class-report", visible: ["admin", "teacher"] },
      { icon: <MdAssessment />, label: "Live Meeting Report", href: "/list/zoom/meeting-report", visible: ["admin", "teacher"] },
      { icon: <MdSettings />, label: "Setting", href: "/list/zoom/zoom-setting", visible: ["admin", "teacher"] },
    ],
  },
  {
    ...
    items: [
      { icon: <MdReportProblem />, label: "Assign Incident", href: "/list/behaviour/assign-incident", visible: ["admin", "teacher"] },
      { icon: <MdReportProblem />, label: "Incidents", href: "/list/behaviour/incident", visible: ["admin", "teacher"] },
      { icon: <MdAnalytics />, label: "Reports", href: "/list/behaviour/behaviour-report", visible: ["admin", "teacher"] },
      { icon: <MdSettings />, label: "Setting", href: "/list/behaviour/behaviour-setting", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Income",
    icon: <MdAttachMoney className="text-lg" />,
    items: [
      { icon: <MdAttachMoney />, label: "Add Income", href: "/list/income/add-income", visible: ["admin", "teacher"] },
      { icon: <MdSearch />, label: "Search Income", href: "/list/income/search-income", visible: ["admin", "teacher"] },
      { icon: <MdCategory />, label: "Income Head", href: "/list/income/head-income", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Expenses",
    icon: <MdAttachMoney className="text-lg" />,
    items: [
      { icon: <MdAttachMoney />, label: "Add Expense", href: "/list/expenses/add-expense", visible: ["admin", "teacher"] },
      { icon: <MdSearch />, label: "Search Expense", href: "/list/expenses/search-expense", visible: ["admin", "teacher"] },
      { icon: <MdCategory />, label: "Expense Head", href: "/list/expenses/head-expense", visible: ["admin", "teacher"] },
    ],
  },
  {
    ...
    items: [
      ...
      { icon: <MdEventNote />, label: "Exam Schedule", href: "/list/cbse/exam-schedule", visible: ["admin", "teacher"] },
      ...
      { icon: <MdTune />, label: "Observation Parameter", href: "/list/cbse/observation-parameter", visible: ["admin", "teacher"] },
      ...
      { icon: <MdSettings />, label: "Setting", href: "/list/cbse/cbse-setting", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Examinations",
    ...
    items: [
      ...
      { icon: <MdOutlineBarChart />, label: "Marks Division", href: "/list/examination/marks-division", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Attendance",
  ...
  },
  {
    ...
    items: [
      { icon: <MdSchedule />, label: "Class Timetable", href: "/list/academics/class-timetable", visible: ["admin", "teacher"] },
      { icon: <MdSchedule />, label: "Teacher Timetable", href: "/list/academics/teacher-timetable", visible: ["admin", "teacher"] },
      { icon: <MdPersonAdd />, label: "Assign Class Teacher", href: "/list/academics/assign-teacher", visible: ["admin", "teacher"] },
      { icon: <MdUpgrade />, label: "Promote Students", href: "/list/academics/promote-student", visible: ["admin", "teacher"] },
      { icon: <MdGroupWork />, label: "Subject Group", href: "/list/academics/subject-group", visible: ["admin", "teacher"] },
  ...
  },
  {
    ...
    items: [
      { icon: <MdCalendarMonth />, label: "Annual Calendar", href: "/list/annual-calendar", visible: ["admin", "teacher"], },
      { icon: <MdCategory />, label: "Holiday Type", href: "/list/annual-calendar/holiday-type", visible: ["admin", "teacher"], },
      { icon: <MdCategory />, label: "Holiday Two", href: "/list/annual-calendar/holiday-two", visible: ["admin", "teacher"], },
  ...
  },
  {
    ...
    items: [
      { icon: <MdContentCopy />, label: "Copy Old Lessons", href: "/list/lesson-plan/copy-old-lesson", visible: ["admin", "teacher"] },
  ...
  },
  {
    ...
    items: [
      { icon: <MdGroups />, label: "Staff Directory", href: "/list/human-resource/staff-directory", visible: ["admin", "teacher"] },
      { icon: <MdChecklist />, label: "Staff Attendance", href: "/list/human-resource/staff-attendance", visible: ["admin", "teacher"] },
      { icon: <MdAttachMoney />, label: "Payroll", href: "/list/human-resource/payroll", visible: ["admin", "teacher"] },
      { icon: <MdCheckCircle />, label: "Approve Leave Request", href: "/list/human-resource/approve-leave", visible: ["admin", "teacher"] },
      { icon: <MdEditDocument />, label: "Apply Leave", href: "/list/human-resource/apply-leave", visible: ["admin", "teacher"] },
      { icon: <MdLabel />, label: "Leave Type", href: "/list/human-resource/leave-type", visible: ["admin", "teacher"] },
      { icon: <MdOutlineBarChart />, label: "Teachers Rating", href: "/list/human-resource/teachers-rating", visible: ["admin", "teacher"] },
      { icon: <MdDashboard />, label: "Department", href: "/list/human-resource/department", visible: ["admin", "teacher"] },
      { icon: <MdPersonAdd />, label: "Designation", href: "/list/human-resource/designation", visible: ["admin", "teacher"] },
      { icon: <MdBlock />, label: "Disabled Staff", href: "/list/human-resource/disable-staff", visible: ["admin", "teacher"] },
    ],
  },
  {
    ...
    items: [
      { icon: <MdNotifications />, label: "Notice Board", href: "/list/communication/notice-board", visible: ["admin", "teacher"] },
      { icon: <MdSend />, label: "Send Email", href: "/list/communication/send-email", visible: ["admin", "teacher"] },
      { icon: <MdSend />, label: "Send SMS", href: "/list/communication/send-sms", visible: ["admin", "teacher"] },
      { icon: <MdInbox />, label: "Email / SMS Log", href: "/list/communication/email-sms-log", visible: ["admin", "teacher"] },
      { icon: <MdSchedule />, label: "Schedule Email SMS Log", href: "/list/communication/schedule-log", visible: ["admin", "teacher"] },
      { icon: <MdPerson />, label: "Login Credentials Send", href: "/list/communication/send-credentials", visible: ["admin", "teacher"] },
      { icon: <MdOutlineArticle />, label: "Email Template", href: "/list/communication/email-template", visible: ["admin", "teacher"] },
      { icon: <MdOutlineArticle />, label: "SMS Template", href: "/list/communication/sms-template", visible: ["admin", "teacher"] },
    ],
  },
  ...
  },
  {
    ...
    items: [
      { icon: <MdEvent />, label: "Event", href: "/list/front-cms/event", visible: ["admin", "teacher"] },
      { icon: <MdPhotoLibrary />, label: "Gallery", href: "/list/front-cms/gallery", visible: ["admin", "teacher"] },
      { icon: <MdAnnouncement />, label: "News", href: "/list/front-cms/news", visible: ["admin", "teacher"] },
      { icon: <MdPermMedia />, label: "Media Manager", href: "/list/front-cms/media-manager", visible: ["admin", "teacher"] },
      { icon: <MdPages />, label: "Pages", href: "/list/front-cms/pages", visible: ["admin", "teacher"] },
      { icon: <MdMenu />, label: "Menus", href: "/list/front-cms/menus", visible: ["admin", "teacher"] },
      { icon: <MdPhotoSizeSelectActual />, label: "Banner Images", href: "/list/front-cms/banner-images", visible: ["admin", "teacher"] },
    ],
  },
  {
    title: "Alumni",
