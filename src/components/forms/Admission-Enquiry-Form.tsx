...
export default function AdmissionEnquiryForm({
  ...
  const onSubmit = async (formData: FormData) => {
    setLoading(true);
    const toastId = toast.loading(type === "create" ? "Admission Enquiry Submitting..." : "Admission Enquiry Updating...");
    ...
    try {
      ...
      toast.success(
        type === "create" ? "Admission Enquiry Submitted Successfully!" : "Admission Enquiry Updated Successfully!",
        { id: toastId }
      );
