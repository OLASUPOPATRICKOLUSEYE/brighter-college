...
export default function TransportPickUpForm({
  ...
  const onSubmit = async (formData: FormData) => {
    setLoading(true);
    const toastId = toast.loading(type === "create" ? "Transport Pick Up Submitting..." : "Transport Pick Up Updating...");
    ...
    try {
      ...
      toast.success(
        type === "create"
          ? "Transport Pick Up Submitted Successfully!"
          : "Transport Pick Up Updated Successfully!",
        { id: toastId }
      );
