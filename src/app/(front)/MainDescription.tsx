...
const MainDescription = () => {
  return (
    <section className="bg-white py-10 px-4 sm:px-6 md:px-10 lg:px-16 xl:px-32 2xl:px-48 w-full">
      ...
      <div className=" mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8 text-center">
        {/* Feature 1 */}
      ...
      <div className=" mx-auto mt-16 flex flex-col lg:flex-row items-center gap-10">
        {/* Text */}
